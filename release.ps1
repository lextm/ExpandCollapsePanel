...
& $msBuild /p:Configuration=Release /t:restore /p:TargetFrameworkVersion=v4.0 /p:OutputPath=..\bin\net40\
& $msBuild /p:Configuration=Release /t:clean /p:TargetFrameworkVersion=v4.0 /p:OutputPath=..\bin\net40\
& $msBuild /p:Configuration=Release /p:TargetFrameworkVersion=v4.0 /p:OutputPath=..\bin\net40\
